const TABLE_NAME = {
  ...
  EXTRA_WORK_LEAVE_BALANCE: "extra_work_leave_balances",
  EXTRA_WORK_LEAVE_TRANSACTION: "extra_work_leave_transactions",
...
const TABLE_MODEL_MAPPING = {
  ...
  [TABLE_NAME.EXTRA_WORK_LEAVE_BALANCE]: "ExtraWorkLeaveBalance",
  [TABLE_NAME.EXTRA_WORK_LEAVE_TRANSACTION]: "ExtraWorkLeaveTransaction",
